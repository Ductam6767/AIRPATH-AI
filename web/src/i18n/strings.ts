...
export const STRINGS = {
  en: {
    ...
    cueRoundabout: (exit: number) => `Roundabout · take exit ${exit}`,
    cueLaneInner: 'Move into the inner lane for the turn',
    cueLaneOuter: 'Keep the outer lane for the turn',
  ...
  vi: {
    ...
    cueRoundabout: (exit: number) => `Bùng binh · lấy lối ${exit}`,
    cueLaneInner: 'Chuyển vào làn trong để rẽ',
    cueLaneOuter: 'Giữ làn ngoài để rẽ',
